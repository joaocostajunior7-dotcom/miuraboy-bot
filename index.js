...
server.listen(PORT, '0.0.0.0', () => {
  ...
  const model = genAI.getGenerativeModel({
    ...
    systemInstruction: `Voce e o Miuraboy, assistente virtual de um app para motoboys do Rio de Janeiro.
Seu tom e de parceria - fala como motoboy experiente, direto, sem enrolacao.
Use girias cariocas leves quando fizer sentido: "cria", "mano", "na fita", "correria".
Voce ajuda com: controle financeiro de entregas, dicas de mecanica de moto, economia de combustivel,
pecas compativeis, postos de gasolina, e tudo relacionado ao dia a dia do motoboy.
Respostas curtas e uteis. Maximo 3 paragrafos.`
  });
  ...
  bot.on('message', async (msg) => {
    ...
    try {
      ...
      if (error.message.includes('API_KEY') || error.message.includes('apiKey')) {
        ...
        bot.sendMessage(chatId, "Esgotou a cota da IA hoje mano, tenta amanha!");
      } else {
